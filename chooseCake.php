...
<div class="container">
    <div class="row justify-content-center px-5 pt-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center align-items-start gap-4">
            ...
            <label class="form-check-label kage-valg">
                <input type="radio" name="kagetype" value="kagemand" class="form-check-input d-none">
                <h5 class="text-start">Kagemand</h5>
                <div class="d-flex justify-content-center">
                    <img src="images/vandbakkelse.webp" alt="Kagemand" class="img-fluid">
                </div>
            </label>

            <label class="form-check-label kage-valg">
                <input type="radio" name="kagetype" value="kagekvinde" class="form-check-input d-none">
                <h5 class="text-start">Kagekvinde</h5>
                <div class="d-flex justify-content-center">
                    <img src="images/Hindbærsnitte%20(1).webp" alt="Kagekvinde" class="img-fluid">
                </div>
            </label>
            ...
            <label class="form-check-label kage-valg">
                ...
                <div class="d-flex justify-content-center">
                    <img src="images/tebolle.webp" alt="Kageperson" class="img-fluid">
                </div>
            </label>
        </div>

        <div class="d-flex justify-content-center align-items-center flex-column py-5 gap-2">
            <button class="btn btn-primary rounded-3 text-white p-3 px-4">VIDERE <i class="fa-solid fa-arrow-right"></i></button>
            <button class="btn btn-white rounded-3 text-decoration-underline"><i class="fa-solid fa-arrow-left"></i> TILBAGE</button>
        </div>
    </div>
</div>
